        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {matches.map((match, i) => (
            <motion.div
              ...
              className="bg-white rounded-3xl p-4 shadow-sm hover:shadow-md cursor-pointer transition-all transform hover:-translate-y-1 flex flex-col items-center border border-transparent hover:border-brand-pink"
            >
